...
export default function RootLayout({ children }) {
    ...
    <div className="relative flex h-16 items-center justify-between">
      ...
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div className="hidden sm:ml-6 sm:block">
          <div className="flex space-x-4">
            ...
            <Link href="/" className = {currentPage === null ? ("bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium") : ("text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium")}  >Homepage</Link>

            <Link href="/login" className= {currentPage === 'login' ? ("bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium") : ("text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium")} >Login</Link>

            <Link href="/tutorial" className= {currentPage === 'tutorial' ? ("bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium") : ("text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium")} >Tutorial</Link>
      ...
      <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <div className="relative ml-3">
          <div>
            <button type="button" className="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true" onClick = {() => setProfileBoxVisible(!profileBoxVisible)}>
              <span className="sr-only">Open user menu</span>
              <img className="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
            </button>
          </div>
          {profileBoxVisible === true ? (<div className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabIndex="-1" >
  ...
  <div className="sm:hidden" id="mobile-menu">
    <div className="space-y-1 px-2 pb-3 pt-2">
      ...
      <Link href="/" className={currentPage === null ? ("bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium") : ("text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium")} aria-current="page">Homepage</Link>

      <Link href="/login" className={currentPage === 'login' ? ("bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium") : ("text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium")} >Login</Link>

      <Link href="/tutorial" className={currentPage === 'tutorial' ? ("bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium") : ("text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium")} >Tutorial</Link>
        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <Link href="https://flowbite.com/" className="flex items-center">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">BatChat</span>
              </Link>
          </div>
